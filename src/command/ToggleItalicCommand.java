...
public class ToggleItalicCommand implements ICommand{
	...
	public ToggleItalicCommand(Graphics graphics, Composition document, int startFrom, int endAt){
	...
	public boolean execute() {
		Boolean val = true;
		try{
			Font newFont = new Font(this.previousFont.getName(), this.previousFont.getStyle() | Font.ITALIC, this.previousFont.getSize());
