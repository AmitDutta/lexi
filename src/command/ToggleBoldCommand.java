...
public class ToggleBoldCommand implements ICommand{
	...
	public ToggleBoldCommand(Graphics graphics, Composition document, int startFrom, int endAt){
	...
	public boolean execute() {
		Boolean val = true;
		try{
			Font newFont = new Font(this.previousFont.getName(), this.previousFont.getStyle() | Font.BOLD, this.previousFont.getSize());
